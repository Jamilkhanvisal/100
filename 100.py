...
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m WHATSAPP   \x1b[1;97m: \x1b[1;97m0789937452
...
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m GITHUB     \x1b[1;97m:\x1b[1;97m Alhamodeen Atal
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m VERSION    \x1b[1;97m:\x1b[1;97m 3.6
\x1b[1;92m----------------------------------------------------    """)
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[ATAL] Example  : 070,079,078,****Etc')
    print('\x1b[1;92m[HAQANI] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[ATAL] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[ATAL] Example  : 2000,3000,5000,****Etc')
    print('\x1b[1;92m[ATAL] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[ATAL] Idz Lemit : '))
    print(46*'-')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[ATAL] Example  : 070,078,077,****Etc')
    print('\x1b[1;92m[ATAL] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[ATAL] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[ATAL] Example  : 5000,100000,****Etc')
    print('\x1b[1;92m[ATAL] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[ATAL] Idz Lemit : '))
    print(46*'-')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[ATAL] Example  : 9370,9378,9377,****Etc')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[ATAL] Example  : 0306,92***,92***,****Etc')
    print('\x1b[1;92m[+] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[ATAL] Your Code : ')
    lines()
    ...
    lines()
    limit = int(input('[ATAL] YOUR LEMIT : '))
    print(46*'-')
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
...
def b2():
    ...
    os.system('clear')
    print(logo)
    print('[ATAL] Example  : 92***,92***,92***,****Etc')
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Mafia9370/ATAL/blob/main/approval.txt').text
    if id in httpCaht:
